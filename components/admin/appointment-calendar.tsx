            ...
            <div className="relative">
              ...
              {days.map((day, dayIndex) => {
                ...
                return dayAppointments.map((appointment) => {
                  ...
                  const top = ((startHour - 7) * 60 + startMinutes) * (48 / 60)
                  const height = ((endHour - startHour) * 60 + (endMinutes - startMinutes)) * (48 / 60)
                  const left = 64 + (dayIndex + 1) * (100 / 8) // 64px for time column
                  ...
                  <div className="space-y-1">
                    {dayAppointments.slice(0, 2).map((appointment) => (
                      ...
                      >
                        ...
                        <div className="truncate text-gray-400">{appointment.customer}</div>
                      </div>
                    ))}
                    ...
                    {dayAppointments.length > 2 && (
                      <button
                        ...
                        onClick={() => {
                          // You could implement a modal to show all appointments for this day
                          setCurrentDate(day)
                        }}
                      >
