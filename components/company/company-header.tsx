      ...
      <div className="flex h-full items-center justify-between">
        <div>
          ...
          <div className="flex items-center gap-2">
            <p className="text-sm text-gray-400">{user?.role ? getRoleDisplay(user.role) : "Company User"}</p>
        ...
        <div className="flex items-center gap-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="flex items-center gap-2 text-gray-400 hover:text-white hover:bg-[#2a3349] px-3"
              >
